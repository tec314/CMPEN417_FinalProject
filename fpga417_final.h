...
void top_fir(FIR input_real[LENGTH], FIR input_img[LENGTH], FIR kernel_real[KERNEL_SIZE], FIR kernel_img[KERNEL_SIZE], FIR_OUT output_img[25], FIR_OUT output_real[25]);
